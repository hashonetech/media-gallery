...
package com.hashone.media.gallery.toggle.widget;
...
import com.hashone.media.gallery.test.R;
import com.hashone.media.gallery.toggle.model.ToggleableView;
...
public class LabeledSwitch extends ToggleableView {
    ...
    private void initView() {
        ...
        colorBorder = colorOn = getResources().getColor(R.color.blue, getContext().getTheme());
